...
from UsersListOrg.forms import LoginForm, RegistrationForm, ResetPasswordForm
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            return redirect(next_page) if next_page else redirect(url_for('register.html'))
        else:
...
def register():
    ...
    if form.validate_on_submit():
        ...
        flash('An email has been sent with instructions to reset new member password.', 'info')
